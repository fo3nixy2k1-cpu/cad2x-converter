...
conn.on('ready', () => {
  conn.sftp((err, sftp) => {
    ...
    sftp.writeFile('/home/y2k1/mem_probe.py', fs.readFileSync('C:/Users/y2k1/.openclaw/workspace/mem_probe.py', 'utf8'), (err2) => {
      if (err2) { console.error('Write error:', err2); conn.end(); return; }
      conn.exec('find /home/y2k1/.openclaw/memory/ -type f 2>&1 | head -30; echo "---"; /usr/bin/python3 /home/y2k1/mem_probe.py 2>&1', (err3, stream3) => {
        let out = '';
